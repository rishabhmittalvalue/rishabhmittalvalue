# Hi, I'm Rishabh Mittal 👋

**Kellogg MBA (MMM) | ex-Sprinklr | PM & Strategy | AI Enthusiast**

---

### What I Do

- 🧠 **Build at the intersection of product, strategy, and AI** — translating messy problems into crisp frameworks and actionable roadmaps
- 📊 **Drive go-to-market & business development** — from market sizing and competitive analysis to partnership strategy and revenue plays
- 🤖 **Explore AI/ML applications for business** — experimenting with LLMs, prompt engineering, and AI-native product strategy
- 🎓 **Currently at Kellogg (MMM Program)** — pursuing MBA + MS in Design Innovation at Northwestern University
...
- **Previously:** Product & Strategy at [Sprinklr](https://www.sprinklr.com) — enterprise SaaS, cross-functional PM work across CRM, analytics, and AI features
- **Education:** MBA @ Kellogg School of Management (Northwestern) · B.E. @ NSIT Delhi
- **Focus Areas:** Product Management · Business Development · AI/ML Applications · Go-To-Market Strategy · Venture & Startups
